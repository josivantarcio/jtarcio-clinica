  ...
  fastify.get(
    ...
    async (
      ...
      try {
        ...
        const withActiveDoctorsBool =
          withActiveDoctors === 'true' || withActiveDoctors === true;
        ...
        // Temporarily disabled complex doctor filtering to avoid errors
        // TODO: Re-enable when doctor relations are fully tested

        // Simplified query without complex relations to avoid errors
